...
output: 
  md_document:
    variant: markdown_github # Cambiar a md_document
---
...
```{r graph_hist, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.height=4.5, fig.width=4.5}
...
```{r graph_ecdf, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.height=4.5, fig.width=4.5}
